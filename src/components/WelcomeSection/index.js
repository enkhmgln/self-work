...
<Image src={img} alt={'image'} className={'w-full h-full rounded object-contain'}/>
            ...
            <div className={'w-full md:w-1/3 font-mono text-thin'}>
                <h1 className={'py-4 text-lg'}>Welcome to Terelj hotel
                </h1>
                <h2 className={'text-sm '}>Terelj hotel is a family-owned hotel that desires to cater and provide guests with personalized hospitality based on what they prefer.
